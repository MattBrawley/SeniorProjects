...
def main():
    ...
    ############################################################
    print('R E M E M B E R : : ID =', allDesigns[42].ID)
    print('R E M E M B E R : : orbits =', allDesigns[42].orbits)
    print('R E M E M B E R : : numSats =', allDesigns[42].numSats)
    print('R E M E M B E R : : totSats =', allDesigns[42].totSats)
    print('R E M E M B E R : : solarPanelSize =', allDesigns[42].solarPanelSize)
    print('R E M E M B E R : : batterySize =', allDesigns[42].batterySize)
    print('R E M E M B E R : : laserPower =', allDesigns[42].laserPower)
    print('R E M E M B E R : : apetRad =', allDesigns[42].apetRad)
    print('R E M E M B E R : : receiverRad_power =', allDesigns[42].receiverRad_power)
    print('R E M E M B E R : : diameterTxM =', allDesigns[42].diameterTxM)
    print('R E M E M B E R : : diameterTxO =', allDesigns[42].diameterTxO)
    print('R E M E M B E R : : dataRate =', allDesigns[42].dataRate)
    print('R E M E M B E R : : dataRate_ED =', allDesigns[42].dataRate_ED)
    print('R E M E M B E R : : commsObj =', allDesigns[42].commsObj)
    print('R E M E M B E R : : powerObj =', allDesigns[42].powerObj)
    print('R E M E M B E R : : roiObj =', allDesigns[42].roiObj)
    print('R E M E M B E R : : constraint =', allDesigns[42].constraint)
    ############################################################
